...
//	status为0，表示正常，1表示取消
	...
	public Meeting(String meetingname, int roomid, int reservationistid,
			...
			Timestamp reservationtime, Timestamp canceledtime,
	...
	public Meeting(int meetingid, String meetingname, int roomid,
			int reservationistid, int numberofparticipants,
			Timestamp starttime, Timestamp endtime, Timestamp reservationtime,
